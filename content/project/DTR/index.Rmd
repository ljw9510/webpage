...
For example, when $k=2$, we have time-ordered variables $(X_{1}, A_{1}, X_{2}, A_{2}, Y)$, where the dependency between them can be described as the following directed acyclic graph (DAG):

<center>
![Figure 1. Directed acyclic graph for k=2](figures/dag.png){width=80%}
</center>
